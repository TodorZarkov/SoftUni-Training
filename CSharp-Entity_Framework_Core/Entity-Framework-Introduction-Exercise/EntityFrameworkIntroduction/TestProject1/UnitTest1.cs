...
public class Test_011_001_001
{
    ...
    private void Seed(SoftUniContext context)
    {
        ...
        var projectStartDates = new[]
        {
            ...
            DateTime.ParseExact("7/14/2017 1:12:32", "M/d/yyyy h:mm:ss", null),
            DateTime.ParseExact("8/16/2017 1:12:32", "M/d/yyyy h:mm:ss", null),
            DateTime.ParseExact("9/18/2017 1:12:32", "M/d/yyyy h:mm:ss", null),
            DateTime.ParseExact("10/20/2017 1:12:32", "M/d/yyyy h:mm:ss", null),
            DateTime.ParseExact("12/22/2017 1:12:32", "M/d/yyyy h:mm:ss", null),
            DateTime.ParseExact("12/24/2017 1:12:32", "M/d/yyyy h:mm:ss", null),
        };
